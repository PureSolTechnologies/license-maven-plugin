...
public class ArtifactInformation implements Serializable {
    ...
    public ArtifactInformation(String groupId, String artifactId, String version, String classifier, String type,
            String scope) {
        super();
    ...
    public ArtifactInformation(Artifact artifact) {
        this(artifact.getGroupId(), artifact.getArtifactId(), artifact.getVersion(), artifact.getClassifier(),
