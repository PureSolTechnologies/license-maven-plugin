...
public class ReportMojo extends AbstractValidationMojo implements MavenReport {
	...
	/**
	 * Specifies the results directory where the results of the validate run
	 * were saved.
	 */
	...
	/**
	 * Specified whether or not the dependencies should be checked recursively.
	...
	/**
	 * Reads the settings from the former validate run and fills
	 * {@link #recursive} and {@link #skipTestScope}.
	 * 
